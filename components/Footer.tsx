  ...
  return (
    <footer className="overflow-x-hidden mt-auto flex-0 ">
      <div className="container">
        <div className="border-t-2 border-grey-500 mt-24 lg:mt-32 py-16 lg:py-32 grid grid-cols-6 lg:grid-cols-12 gap-10">
          ...
          <div className="col-span-full lg:col-span-4 xl:col-span-3 xl:col-start-10 lg:text-right">
            <p>
            ...
            <nav className="mt-4 flex items-center lg:justify-end gap-6">
              {mastodon && (
                <Link href={mastodon}>
                  <svg
