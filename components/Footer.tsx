...
<footer className="overflow-x-hidden mt-auto flex-0">
		<div className="container my-24 lg:my-32 grid grid-cols-12 gap-10">
			<div className="col-span-8">
				<p className="text-[40px] mb-4">Have a project and want to collaborate?</p>
				<a href="#" className="inline-block relative text-[82px] font-bold text-blue group">
					Let's Jam Together.
			...
			<div className="col-span-4 xl:col-span-3 xl:col-start-10 text-right">
			 	<p><a className="text-lg font-semibold" href="/">Jack Whiting</a></p>
			 	<p className="mt-3"><a href="mailto:hi@jackwhiting.co.uk">hi@jackwhiting.co.uk</a></p>
			 	...
			 	<p className="text-sm mt-5">&copy; 2024+. Trading as By JAM Ltd. Registered as a company in England & Wales, company registration number 11214431</p>
			</div>
